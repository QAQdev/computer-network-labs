...
add_custom_target (check_lab2 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_webget|t_send_|t_recv_|t_wrapping_|t_strm_reassem_|t_byte_stream|_dt'
                              COMMENT "Testing the TCP receiver and the TCP sender...")
...
add_custom_target (check_lab3 COMMAND "${PROJECT_SOURCE_DIR}/tun.sh" check 144 145
...
add_custom_target (check_lab1 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R '^arp_|^router_'
                              COMMENT "Testing Lab 1...")
